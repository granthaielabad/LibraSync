...
public class Form_User_Dashboard extends javax.swing.JPanel {

    public Form_User_Dashboard() {
        initComponents();
    ...
    private void initComponents() {
        ...
        panel1.add(card_User5);
        panel1.add(card_User6);
        panel1.add(card_User7);
        panel1.add(card_User8);
